...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Proposal.kind'
        db.delete_column('proposals_proposal', 'kind_id')

        # Adding field 'Proposal.kind_id'
        db.add_column('proposals_proposal', 'kind_id',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Proposal.kind'
        db.add_column('proposals_proposal', 'kind',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['conference.PresentationKind']),
                      keep_default=False)

        # Deleting field 'Proposal.kind_id'
        db.delete_column('proposals_proposal', 'kind_id')
    ...
    models = {
        ...
        'proposals.proposal': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind_id': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
