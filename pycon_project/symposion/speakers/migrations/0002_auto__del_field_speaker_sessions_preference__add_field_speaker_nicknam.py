...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Speaker.sessions_preference'
        db.delete_column('speakers_speaker', 'sessions_preference')

        # Adding field 'Speaker.nickname'
        db.add_column('speakers_speaker', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Speaker.sessions_preference'
        db.add_column('speakers_speaker', 'sessions_preference',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Speaker.nickname'
        db.delete_column('speakers_speaker', 'nickname')
